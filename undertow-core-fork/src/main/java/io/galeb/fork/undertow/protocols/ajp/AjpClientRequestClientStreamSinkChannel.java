...
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_AUTH_TYPE;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_QUERY_STRING;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_REMOTE_USER;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_ROUTE;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_SECRET;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_SSL_CERT;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_SSL_CIPHER;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_SSL_KEY_SIZE;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_SSL_SESSION;
import static io.galeb.fork.undertow.protocols.ajp.AjpConstants.ATTR_STORED_METHOD;
import static io.galeb.fork.undertow.protocols.ajp.AjpUtils.notNull;
import static io.galeb.fork.undertow.protocols.ajp.AjpUtils.putString;

import java.io.IOException;
import java.nio.ByteBuffer;

import io.galeb.fork.undertow.UndertowOptions;
import io.galeb.fork.undertow.util.ImmediatePooledByteBuffer;
import org.xnio.ChannelListener;
import io.galeb.fork.undertow.connector.PooledByteBuffer;

import io.galeb.fork.undertow.UndertowMessages;
import io.galeb.fork.undertow.client.ProxiedRequestAttachments;
import io.galeb.fork.undertow.server.protocol.framed.SendFrameHeader;
import io.galeb.fork.undertow.util.Attachable;
import io.galeb.fork.undertow.util.FlexBase64;
import io.galeb.fork.undertow.util.HeaderMap;
