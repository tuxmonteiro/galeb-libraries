...
package io.galeb.fork.undertow.server.protocol.http;
...
import io.galeb.fork.undertow.util.Methods;
import io.galeb.fork.undertow.util.Protocols;
import io.galeb.fork.undertow.util.URLUtils;
import org.xnio.OptionMap;

import static io.galeb.fork.undertow.util.Headers.ACCEPT_CHARSET_STRING;
import static io.galeb.fork.undertow.util.Headers.ACCEPT_ENCODING_STRING;
import static io.galeb.fork.undertow.util.Headers.ACCEPT_LANGUAGE_STRING;
import static io.galeb.fork.undertow.util.Headers.ACCEPT_RANGES_STRING;
import static io.galeb.fork.undertow.util.Headers.ACCEPT_STRING;
import static io.galeb.fork.undertow.util.Headers.AUTHORIZATION_STRING;
import static io.galeb.fork.undertow.util.Headers.CACHE_CONTROL_STRING;
import static io.galeb.fork.undertow.util.Headers.CONNECTION_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_LENGTH_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_TYPE_STRING;
import static io.galeb.fork.undertow.util.Headers.COOKIE_STRING;
import static io.galeb.fork.undertow.util.Headers.EXPECT_STRING;
import static io.galeb.fork.undertow.util.Headers.FROM_STRING;
import static io.galeb.fork.undertow.util.Headers.HOST_STRING;
import static io.galeb.fork.undertow.util.Headers.IF_MATCH_STRING;
import static io.galeb.fork.undertow.util.Headers.IF_MODIFIED_SINCE_STRING;
import static io.galeb.fork.undertow.util.Headers.IF_NONE_MATCH_STRING;
import static io.galeb.fork.undertow.util.Headers.IF_RANGE_STRING;
import static io.galeb.fork.undertow.util.Headers.IF_UNMODIFIED_SINCE_STRING;
import static io.galeb.fork.undertow.util.Headers.MAX_FORWARDS_STRING;
import static io.galeb.fork.undertow.util.Headers.ORIGIN_STRING;
import static io.galeb.fork.undertow.util.Headers.PRAGMA_STRING;
import static io.galeb.fork.undertow.util.Headers.PROXY_AUTHORIZATION_STRING;
import static io.galeb.fork.undertow.util.Headers.RANGE_STRING;
import static io.galeb.fork.undertow.util.Headers.REFERER_STRING;
import static io.galeb.fork.undertow.util.Headers.REFRESH_STRING;
import static io.galeb.fork.undertow.util.Headers.SEC_WEB_SOCKET_KEY_STRING;
import static io.galeb.fork.undertow.util.Headers.SEC_WEB_SOCKET_VERSION_STRING;
import static io.galeb.fork.undertow.util.Headers.SERVER_STRING;
import static io.galeb.fork.undertow.util.Headers.SSL_CIPHER_STRING;
import static io.galeb.fork.undertow.util.Headers.SSL_CIPHER_USEKEYSIZE_STRING;
import static io.galeb.fork.undertow.util.Headers.SSL_CLIENT_CERT_STRING;
import static io.galeb.fork.undertow.util.Headers.SSL_SESSION_ID_STRING;
import static io.galeb.fork.undertow.util.Headers.STRICT_TRANSPORT_SECURITY_STRING;
import static io.galeb.fork.undertow.util.Headers.TRAILER_STRING;
import static io.galeb.fork.undertow.util.Headers.TRANSFER_ENCODING_STRING;
import static io.galeb.fork.undertow.util.Headers.UPGRADE_STRING;
import static io.galeb.fork.undertow.util.Headers.USER_AGENT_STRING;
import static io.galeb.fork.undertow.util.Headers.VIA_STRING;
import static io.galeb.fork.undertow.util.Headers.WARNING_STRING;
import static io.galeb.fork.undertow.util.Methods.CONNECT_STRING;
import static io.galeb.fork.undertow.util.Methods.DELETE_STRING;
import static io.galeb.fork.undertow.util.Methods.GET_STRING;
import static io.galeb.fork.undertow.util.Methods.HEAD_STRING;
import static io.galeb.fork.undertow.util.Methods.OPTIONS_STRING;
import static io.galeb.fork.undertow.util.Methods.POST_STRING;
import static io.galeb.fork.undertow.util.Methods.PUT_STRING;
import static io.galeb.fork.undertow.util.Methods.TRACE_STRING;
import static io.galeb.fork.undertow.util.Protocols.HTTP_0_9_STRING;
import static io.galeb.fork.undertow.util.Protocols.HTTP_1_0_STRING;
import static io.galeb.fork.undertow.util.Protocols.HTTP_1_1_STRING;
import static io.galeb.fork.undertow.util.Protocols.HTTP_2_0_STRING;

/**
 * The basic HTTP parser. The actual parser is a sub class of this class that is generated as part of
 * the build process by the {@link io.galeb.fork.undertow.annotationprocessor.AbstractParserGenerator} annotation processor.
 * <p>
