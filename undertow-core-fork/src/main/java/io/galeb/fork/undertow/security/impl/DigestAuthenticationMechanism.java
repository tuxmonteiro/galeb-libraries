 ...
 */
package io.galeb.fork.undertow.security.impl;

import static io.galeb.fork.undertow.UndertowLogger.REQUEST_LOGGER;
import static io.galeb.fork.undertow.UndertowMessages.MESSAGES;
import static io.galeb.fork.undertow.security.impl.DigestAuthorizationToken.parseHeader;
import static io.galeb.fork.undertow.util.Headers.AUTHENTICATION_INFO;
import static io.galeb.fork.undertow.util.Headers.AUTHORIZATION;
import static io.galeb.fork.undertow.util.Headers.DIGEST;
import static io.galeb.fork.undertow.util.Headers.NEXT_NONCE;
import static io.galeb.fork.undertow.util.Headers.WWW_AUTHENTICATE;
import static io.galeb.fork.undertow.util.StatusCodes.UNAUTHORIZED;
import io.galeb.fork.undertow.security.api.AuthenticationMechanism;
import io.galeb.fork.undertow.security.api.AuthenticationMechanismFactory;
import io.galeb.fork.undertow.security.api.NonceManager;
import io.galeb.fork.undertow.security.api.SecurityContext;
import io.galeb.fork.undertow.security.idm.Account;
import io.galeb.fork.undertow.security.idm.DigestAlgorithm;
import io.galeb.fork.undertow.security.idm.DigestCredential;
import io.galeb.fork.undertow.security.idm.IdentityManager;
...
import io.galeb.fork.undertow.util.HexConverter;
