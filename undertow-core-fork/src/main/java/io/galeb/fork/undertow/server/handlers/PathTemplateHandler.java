...
public class PathTemplateHandler implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        exchange.putAttachment(io.galeb.fork.undertow.util.PathTemplateMatch.ATTACHMENT_KEY, new io.galeb.fork.undertow.util.PathTemplateMatch(match.getMatchedTemplate(), match.getParameters()));
