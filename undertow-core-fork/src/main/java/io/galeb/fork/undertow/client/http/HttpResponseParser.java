...
package io.galeb.fork.undertow.client.http;
...
import static io.galeb.fork.undertow.util.Headers.AGE_STRING;
...
import static io.galeb.fork.undertow.util.Headers.CONTENT_DISPOSITION_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_ENCODING_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_LANGUAGE_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_LENGTH_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_LOCATION_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_MD5_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_RANGE_STRING;
import static io.galeb.fork.undertow.util.Headers.CONTENT_TYPE_STRING;
import static io.galeb.fork.undertow.util.Headers.DATE_STRING;
import static io.galeb.fork.undertow.util.Headers.ETAG_STRING;
import static io.galeb.fork.undertow.util.Headers.EXPIRES_STRING;
import static io.galeb.fork.undertow.util.Headers.LAST_MODIFIED_STRING;
import static io.galeb.fork.undertow.util.Headers.LOCATION_STRING;
import static io.galeb.fork.undertow.util.Headers.PRAGMA_STRING;
import static io.galeb.fork.undertow.util.Headers.PROXY_AUTHENTICATE_STRING;
import static io.galeb.fork.undertow.util.Headers.REFRESH_STRING;
import static io.galeb.fork.undertow.util.Headers.RETRY_AFTER_STRING;
import static io.galeb.fork.undertow.util.Headers.SERVER_STRING;
import static io.galeb.fork.undertow.util.Headers.SET_COOKIE2_STRING;
import static io.galeb.fork.undertow.util.Headers.SET_COOKIE_STRING;
...
import static io.galeb.fork.undertow.util.Headers.VARY_STRING;
...
import static io.galeb.fork.undertow.util.Headers.WWW_AUTHENTICATE_STRING;
