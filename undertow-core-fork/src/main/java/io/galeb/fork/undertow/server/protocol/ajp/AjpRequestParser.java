...
package io.galeb.fork.undertow.server.protocol.ajp;

import static io.galeb.fork.undertow.util.Methods.ACL;
import static io.galeb.fork.undertow.util.Methods.BASELINE_CONTROL;
import static io.galeb.fork.undertow.util.Methods.CHECKIN;
import static io.galeb.fork.undertow.util.Methods.CHECKOUT;
import static io.galeb.fork.undertow.util.Methods.COPY;
import static io.galeb.fork.undertow.util.Methods.DELETE;
import static io.galeb.fork.undertow.util.Methods.GET;
import static io.galeb.fork.undertow.util.Methods.HEAD;
import static io.galeb.fork.undertow.util.Methods.LABEL;
import static io.galeb.fork.undertow.util.Methods.LOCK;
import static io.galeb.fork.undertow.util.Methods.MERGE;
import static io.galeb.fork.undertow.util.Methods.MKACTIVITY;
import static io.galeb.fork.undertow.util.Methods.MKCOL;
import static io.galeb.fork.undertow.util.Methods.MKWORKSPACE;
import static io.galeb.fork.undertow.util.Methods.MOVE;
import static io.galeb.fork.undertow.util.Methods.OPTIONS;
import static io.galeb.fork.undertow.util.Methods.POST;
import static io.galeb.fork.undertow.util.Methods.PROPFIND;
import static io.galeb.fork.undertow.util.Methods.PROPPATCH;
import static io.galeb.fork.undertow.util.Methods.PUT;
import static io.galeb.fork.undertow.util.Methods.REPORT;
import static io.galeb.fork.undertow.util.Methods.SEARCH;
import static io.galeb.fork.undertow.util.Methods.TRACE;
import static io.galeb.fork.undertow.util.Methods.UNCHECKOUT;
import static io.galeb.fork.undertow.util.Methods.UNLOCK;
import static io.galeb.fork.undertow.util.Methods.UPDATE;
import static io.galeb.fork.undertow.util.Methods.VERSION_CONTROL;
...
import io.galeb.fork.undertow.security.impl.ExternalAuthenticationMechanism;
