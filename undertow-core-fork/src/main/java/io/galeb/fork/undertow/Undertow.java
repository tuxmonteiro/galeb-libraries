...
import io.galeb.fork.undertow.server.protocol.ajp.AjpOpenListener;
import io.galeb.fork.undertow.server.protocol.http.AlpnOpenListener;
import io.galeb.fork.undertow.server.protocol.http.HttpOpenListener;
import io.galeb.fork.undertow.server.protocol.http2.Http2OpenListener;
import io.galeb.fork.undertow.server.protocol.spdy.SpdyOpenListener;
