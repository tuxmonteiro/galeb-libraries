...
import io.galeb.undertow.fork.util.Methods;
import io.galeb.undertow.fork.util.Protocols;
import io.galeb.undertow.fork.util.URLUtils;
import org.xnio.OptionMap;

import static io.galeb.undertow.fork.util.Headers.ACCEPT_CHARSET_STRING;
import static io.galeb.undertow.fork.util.Headers.ACCEPT_ENCODING_STRING;
import static io.galeb.undertow.fork.util.Headers.ACCEPT_LANGUAGE_STRING;
import static io.galeb.undertow.fork.util.Headers.ACCEPT_RANGES_STRING;
import static io.galeb.undertow.fork.util.Headers.ACCEPT_STRING;
import static io.galeb.undertow.fork.util.Headers.AUTHORIZATION_STRING;
import static io.galeb.undertow.fork.util.Headers.CACHE_CONTROL_STRING;
import static io.galeb.undertow.fork.util.Headers.CONNECTION_STRING;
import static io.galeb.undertow.fork.util.Headers.CONTENT_LENGTH_STRING;
import static io.galeb.undertow.fork.util.Headers.CONTENT_TYPE_STRING;
import static io.galeb.undertow.fork.util.Headers.COOKIE_STRING;
import static io.galeb.undertow.fork.util.Headers.EXPECT_STRING;
import static io.galeb.undertow.fork.util.Headers.FROM_STRING;
import static io.galeb.undertow.fork.util.Headers.HOST_STRING;
import static io.galeb.undertow.fork.util.Headers.IF_MATCH_STRING;
import static io.galeb.undertow.fork.util.Headers.IF_MODIFIED_SINCE_STRING;
import static io.galeb.undertow.fork.util.Headers.IF_NONE_MATCH_STRING;
import static io.galeb.undertow.fork.util.Headers.IF_RANGE_STRING;
import static io.galeb.undertow.fork.util.Headers.IF_UNMODIFIED_SINCE_STRING;
import static io.galeb.undertow.fork.util.Headers.MAX_FORWARDS_STRING;
import static io.galeb.undertow.fork.util.Headers.ORIGIN_STRING;
import static io.galeb.undertow.fork.util.Headers.PRAGMA_STRING;
import static io.galeb.undertow.fork.util.Headers.PROXY_AUTHORIZATION_STRING;
import static io.galeb.undertow.fork.util.Headers.RANGE_STRING;
import static io.galeb.undertow.fork.util.Headers.REFERER_STRING;
import static io.galeb.undertow.fork.util.Headers.REFRESH_STRING;
import static io.galeb.undertow.fork.util.Headers.SEC_WEB_SOCKET_KEY_STRING;
import static io.galeb.undertow.fork.util.Headers.SEC_WEB_SOCKET_VERSION_STRING;
import static io.galeb.undertow.fork.util.Headers.SERVER_STRING;
import static io.galeb.undertow.fork.util.Headers.SSL_CIPHER_STRING;
import static io.galeb.undertow.fork.util.Headers.SSL_CIPHER_USEKEYSIZE_STRING;
import static io.galeb.undertow.fork.util.Headers.SSL_CLIENT_CERT_STRING;
import static io.galeb.undertow.fork.util.Headers.SSL_SESSION_ID_STRING;
import static io.galeb.undertow.fork.util.Headers.STRICT_TRANSPORT_SECURITY_STRING;
import static io.galeb.undertow.fork.util.Headers.TRAILER_STRING;
import static io.galeb.undertow.fork.util.Headers.TRANSFER_ENCODING_STRING;
import static io.galeb.undertow.fork.util.Headers.UPGRADE_STRING;
import static io.galeb.undertow.fork.util.Headers.USER_AGENT_STRING;
import static io.galeb.undertow.fork.util.Headers.VIA_STRING;
import static io.galeb.undertow.fork.util.Headers.WARNING_STRING;
import static io.galeb.undertow.fork.util.Methods.CONNECT_STRING;
import static io.galeb.undertow.fork.util.Methods.DELETE_STRING;
import static io.galeb.undertow.fork.util.Methods.GET_STRING;
import static io.galeb.undertow.fork.util.Methods.HEAD_STRING;
import static io.galeb.undertow.fork.util.Methods.OPTIONS_STRING;
import static io.galeb.undertow.fork.util.Methods.POST_STRING;
import static io.galeb.undertow.fork.util.Methods.PUT_STRING;
import static io.galeb.undertow.fork.util.Methods.TRACE_STRING;
import static io.galeb.undertow.fork.util.Protocols.HTTP_0_9_STRING;
import static io.galeb.undertow.fork.util.Protocols.HTTP_1_0_STRING;
import static io.galeb.undertow.fork.util.Protocols.HTTP_1_1_STRING;
import static io.galeb.undertow.fork.util.Protocols.HTTP_2_0_STRING;

/**
 * The basic HTTP parser. The actual parser is a sub class of this class that is generated as part of
 * the build process by the {@link io.galeb.undertow.fork.annotationprocessor.AbstractParserGenerator} annotation processor.
 * <p>
