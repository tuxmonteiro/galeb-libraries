...
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_AUTH_TYPE;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_QUERY_STRING;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_REMOTE_USER;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_ROUTE;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_SECRET;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_SSL_CERT;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_SSL_CIPHER;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_SSL_KEY_SIZE;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_SSL_SESSION;
import static io.galeb.undertow.fork.protocols.ajp.AjpConstants.ATTR_STORED_METHOD;
import static io.galeb.undertow.fork.protocols.ajp.AjpUtils.notNull;
import static io.galeb.undertow.fork.protocols.ajp.AjpUtils.putString;

import java.io.IOException;
import java.nio.ByteBuffer;

import io.galeb.undertow.fork.UndertowOptions;
import io.galeb.undertow.fork.util.ImmediatePooledByteBuffer;
import org.xnio.ChannelListener;
import io.galeb.undertow.fork.connector.PooledByteBuffer;

import io.galeb.undertow.fork.UndertowMessages;
import io.galeb.undertow.fork.client.ProxiedRequestAttachments;
import io.galeb.undertow.fork.server.protocol.framed.SendFrameHeader;
import io.galeb.undertow.fork.util.Attachable;
import io.galeb.undertow.fork.util.FlexBase64;
