...
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_CONTINUATION;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_DATA;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_GOAWAY;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_HEADERS;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_PRIORITY;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_PUSH_PROMISE;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_RST_STREAM;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_SETTINGS;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.FRAME_TYPE_WINDOW_UPDATE;
import static io.galeb.undertow.fork.protocols.http2.Http2Channel.HEADERS_FLAG_END_HEADERS;
...
import io.galeb.undertow.fork.server.protocol.framed.AbstractFramedStreamSourceChannel;
import io.galeb.undertow.fork.server.protocol.framed.FrameHeaderData;
