...
import io.galeb.undertow.fork.util.PathTemplateMatcher;
...
public class PathTemplateHandler implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        exchange.putAttachment(io.galeb.undertow.fork.util.PathTemplateMatch.ATTACHMENT_KEY, new io.galeb.undertow.fork.util.PathTemplateMatch(match.getMatchedTemplate(), match.getParameters()));
