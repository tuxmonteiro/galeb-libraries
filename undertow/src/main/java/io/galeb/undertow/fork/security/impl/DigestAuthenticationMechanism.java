 ...
 */
package io.galeb.undertow.fork.security.impl;

import static io.galeb.undertow.fork.UndertowLogger.REQUEST_LOGGER;
import static io.galeb.undertow.fork.UndertowMessages.MESSAGES;
import static io.galeb.undertow.fork.security.impl.DigestAuthorizationToken.parseHeader;
import static io.galeb.undertow.fork.util.Headers.AUTHENTICATION_INFO;
import static io.galeb.undertow.fork.util.Headers.AUTHORIZATION;
import static io.galeb.undertow.fork.util.Headers.DIGEST;
import static io.galeb.undertow.fork.util.Headers.NEXT_NONCE;
import static io.galeb.undertow.fork.util.Headers.WWW_AUTHENTICATE;
import static io.galeb.undertow.fork.util.StatusCodes.UNAUTHORIZED;
import io.galeb.undertow.fork.security.api.AuthenticationMechanism;
import io.galeb.undertow.fork.security.api.AuthenticationMechanismFactory;
import io.galeb.undertow.fork.security.api.NonceManager;
import io.galeb.undertow.fork.security.api.SecurityContext;
import io.galeb.undertow.fork.security.idm.Account;
import io.galeb.undertow.fork.security.idm.DigestAlgorithm;
import io.galeb.undertow.fork.security.idm.DigestCredential;
import io.galeb.undertow.fork.security.idm.IdentityManager;
...
import io.galeb.undertow.fork.util.AttachmentKey;
import io.galeb.undertow.fork.util.HeaderMap;
import io.galeb.undertow.fork.util.Headers;
import io.galeb.undertow.fork.util.HexConverter;
