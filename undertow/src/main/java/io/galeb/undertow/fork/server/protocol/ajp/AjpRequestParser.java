...
import static io.galeb.undertow.fork.util.Methods.ACL;
import static io.galeb.undertow.fork.util.Methods.BASELINE_CONTROL;
import static io.galeb.undertow.fork.util.Methods.CHECKIN;
import static io.galeb.undertow.fork.util.Methods.CHECKOUT;
import static io.galeb.undertow.fork.util.Methods.COPY;
import static io.galeb.undertow.fork.util.Methods.DELETE;
import static io.galeb.undertow.fork.util.Methods.GET;
import static io.galeb.undertow.fork.util.Methods.HEAD;
import static io.galeb.undertow.fork.util.Methods.LABEL;
import static io.galeb.undertow.fork.util.Methods.LOCK;
import static io.galeb.undertow.fork.util.Methods.MERGE;
import static io.galeb.undertow.fork.util.Methods.MKACTIVITY;
import static io.galeb.undertow.fork.util.Methods.MKCOL;
import static io.galeb.undertow.fork.util.Methods.MKWORKSPACE;
import static io.galeb.undertow.fork.util.Methods.MOVE;
import static io.galeb.undertow.fork.util.Methods.OPTIONS;
import static io.galeb.undertow.fork.util.Methods.POST;
import static io.galeb.undertow.fork.util.Methods.PROPFIND;
import static io.galeb.undertow.fork.util.Methods.PROPPATCH;
import static io.galeb.undertow.fork.util.Methods.PUT;
import static io.galeb.undertow.fork.util.Methods.REPORT;
import static io.galeb.undertow.fork.util.Methods.SEARCH;
import static io.galeb.undertow.fork.util.Methods.TRACE;
import static io.galeb.undertow.fork.util.Methods.UNCHECKOUT;
import static io.galeb.undertow.fork.util.Methods.UNLOCK;
import static io.galeb.undertow.fork.util.Methods.UPDATE;
import static io.galeb.undertow.fork.util.Methods.VERSION_CONTROL;
...
import io.galeb.undertow.fork.security.impl.ExternalAuthenticationMechanism;
